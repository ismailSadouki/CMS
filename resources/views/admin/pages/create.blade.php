          ...
          <div class="container">
            <form method="POST" action="{{route('page.store')}}" enctype="multipart/form-data">
                ...
                <div class="col-lg-5 form-group">
                    ...
                    <input type="text" class="form-control" name="slug"  value="" placeholder="مثال: About" required>
                </div>

                <div class="col-lg-5 form-group">
                    <label for="title"> الوصف </label>
                    <input type="text" class="form-control" name="title"  value="" placeholder="مثال: نبذة عنا " required>
                </div>
