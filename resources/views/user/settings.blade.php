    ...
    <form method="POST" action="{{ route('settings') }}" enctype="multipart/form-data">
        ...
        <div class="row bg-white p-5">
            <div class="col-lg-4 text-center mb-5">
                <img id="avatar_img" src="{{ $user->profile->avatar ?? asset('storage/avatars/avatar.jpeg') }}" class="rounded-circle avatar_preview" alt="avatar">
                <input type="file" id="avatar_file" name="avatar_file" class="">
            </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="form-group row" >
                    <div class="col-lg-9">
                        <input type="submit" class="btn btn-primary" style="width:140px" value="حفظ التعديلات ">
