...
<div class="collapse navbar-collapse navbar-dark" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link" href="{{ url('/') }}"><i class="fa fa-home"></i>&nbsp;{{__('massages.Home')}}</a>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fa fa-file"></i>{{__('massages.Pages')}}
            </a>
    ...
    <ul class="navbar-nav">
        ...
        @else
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ Auth::user()->profile->avatar ?? asset('storage/avatars/avatar.jpeg') }}" alt="Avatar" class="avatar">
                ...
                <div class="dropdown-menu dropdown-menu-right  text-right" aria-labelledby="navbarDropdown">
                    ...
                    @endadmin
                    <a class="dropdown-item" href="{{route('profile',Auth::user()->id)}}"><i class="far fa-user fa-fw"></i>{{__('massages.Profile')}}</a>
                    <a class="dropdown-item" href="{{ route('settings') }}"><i class="fas fa-cog fa-fw"></i>{{__('massages.Settings')}}</a>
